...
Here, we see that physical activity is negatively associated with BMI (a
1 unit difference in physical activity is associated with a 1.64 higher
BMI). Individuals who are physically active have an average BMI that is
1.64 kg/m2 lower than those who are inactive, holding all other
variables constant.
