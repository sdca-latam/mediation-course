...
or stratifying by them (conditioning on a collider) can **introduce** a
spurious association between the exposure and the outcome.
...
**Identifying further potential colliders**: These are variables that
